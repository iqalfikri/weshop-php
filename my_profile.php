        ...
        <ul>
            <li>
                <a <?php if($module=="kategori" ) {echo "class='active'" ;}?>
                    href="<?= BASE_URL ;?>index.php?page=my_profile&module=kategori&action=list">Kategori</a>
            </li>
            <li>
                <a <?php if($module=="barang" ) {echo "class='active'" ;}?>
                    href="<?= BASE_URL ;?>index.php?page=my_profile&module=barang&action=list">Barang</a>
            </li>
            <li>
                <a <?php if($module=="kota" ) {echo "class='active'" ;}?>
                    href="<?= BASE_URL ;?>index.php?page=my_profile&module=kota&action=list">Kota</a>
            </li>
            <li>
            ...
            <li>
                <a <?php if($module=="pesanan" ) {echo "class='active'" ;}?>
                    href="<?= BASE_URL ;?>index.php?page=my_profile&module=pesanan&action=list">Pesanan</a>
            </li>
        </ul>
    </div>
