<div id="frame-tambah">
    <a class="tombol-action" href="<?php echo BASE_URL."index.php?page=my_profile&module=kota&action=form"; ?>">+ Tambah
        Kota</a>
</div>
...
<?php
	...
	$queryKota = mysqli_query($db, "SELECT * FROM kota ORDER BY kota ASC LIMIT $mulai_dari, $data_per_halaman");
	...
	if(mysqli_num_rows($queryKota) == 0){
		...
		echo "</table>";
		$queryHitungKota = mysqli_query($db, "SELECT * FROM kota");
