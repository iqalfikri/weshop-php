...
<?php
    ...
    $query = mysqli_query($db, "SELECT barang.*, kategori.kategori FROM barang JOIN kategori ON barang.kategori_id=kategori.kategori_id $where ORDER BY nama_barang ASC LIMIT $mulai_dari, $data_per_halaman");
    ...
    if (mysqli_num_rows($query) == 0) {
        ...
        while($row=mysqli_fetch_assoc($query)){
            ...
            echo "<tr>
                                ...
                                <td class='tengah'>
                                        ...
                                        <a href='".BASE_URL."module/barang/action.php?button=Delete&barang_id=$row[barang_id]' class='tombol-action'>Delete</a>
                                </td>
            </tr>";
            $no++;
        }
        ...
        $queryHitungBarang = mysqli_query($db, "SELECT * FROM barang $where");
